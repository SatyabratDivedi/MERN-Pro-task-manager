...
const App = () => {
  const {peopleAddFlashPage: showAddPeoplePage, successFlashPage: showSuccessPage, addTodoFlashPage: showAddTodoPage, deleteTodoFlashPage: showDeleteTodoPage, logoutFlashPage: showLogoutPage} = useSelector((state) => state.flashReducer);
  ...
  return (
    <>
      <div style={{display: "flex", height: "100vh", fontFamily: "Poppins"}}>
        ...
        <ConditionalRender show={showDeleteTodoPage}>
          <TodoDeletePage />
        </ConditionalRender>
